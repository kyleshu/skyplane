...
from skyplane.config_paths import aws_quota_path, gcp_quota_path, azure_quota_path, azure_standardDv5_quota_path
...
class TransferConfig:
    ...
    azure_instance_class: str = "Standard_D2_v4"
    ...
    azure_vcpu_file: Path = azure_quota_path
